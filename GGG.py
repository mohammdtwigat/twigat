...
with col_title:
    ...
    <div class="header-box">
        ...
        <div class="header-subtitle">Prepared by Engineer Mohammed Al-Twiqat</div>
    </div>
    """, unsafe_allow_html=True)
...
with st.form("assessment_form"):
    ...
    st.markdown('<div class="section-card">', unsafe_allow_html=True)
    st.markdown('<div class="section-title">10. FIELD ENGINEER FINAL NOTES</div>', unsafe_allow_html=True)
...
if submit:
    ...
    try:
        ...
        st.warning(f"Google Sheets not connected or error: {e}")
